...
if (data == null) {
  ...
  container.innerText = "Your list is currently empty";
} else {
  appenddata(data);
}
...
function appenddata(data) {
  ...
  data.forEach((ele, i) => {
    ...
    Productprice.innerText = `Product Price :- ${Productsprice}`;
    ...
    totalall.innerText = `Total Price :- ${total}`;
  });
}
...
function Rmovedata(ele, i) {
  ...
  //   let Productprice = document.getElementById("total");
  //   Productsprice = Productsprice - (ele.prices.current_price + 4.71);
  ...
  //   totalall = document.getElementById("totalall");
  //   total += 1 * (ele.prices.current_price + 4.71);
  //   total = total - ele.prices.current_price + 4.71;
  //   totalall.innerText = `Total Price :- ${total}`;
