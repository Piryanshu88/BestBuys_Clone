     ...
     <div id="second">
        <div id="second-first">
            <div class="dropdown">
                ...
                <p class="underline">Back-to-School Checklist</p>
                ...
                <div class="dropdown">
                    ...
                    <div class="h" class="dropdown-content">
                        <div class="up">
                            ...
                            <div id="j"><i class="fa fa-times fa-2x"></i></div>
                ...
                <div class="dropdown">
                    ...
                    <div class="h" class="dropdown-content">
                        <div class="l" class="up">
                            ...
                            <div id="n"><i class="fa fa-times fa-2x"></i></div>
                        </div>
                        <p class="underline" class="underline"></p>
                        <div id="down">
                ...
                <div class="dropdown">
                    ...
                    <div class="h" class="dropdown-content">
                        <div class="o" class="up">
                           ...
                           <div class="line1"></div>
                            <p class="underline" id="t">See all your saved items ›</p>
                            <div id="u"><i class="fa fa-times fa-2x"></i></div>
                        ...
                        <div id="down2">
                            <div class="down-first2">
                                ...
                                <p class="underline" id="w">When you see something you like, hit "save" and we'll keep track of it here.</p>
                                <p class="underline" id="w"><span style="color:blue">Sign in</span> or <span style="color:blue">create an account</span>  to see your stuff on all your devices.</p>
                            </div>
