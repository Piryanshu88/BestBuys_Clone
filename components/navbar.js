...
function navbar(){
    ...
    <div id="first">
        ...
        <div id="b">
           ...
           <div id="c" >
                <a href="#"><img id="cart_logo" src="https://api.iconify.design/ant-design/shopping-cart-outlined.svg?color=white"></a>
            ...
            <div  class="dropdown">
                ...
                <p><i class="fa fa-times"></i>Close</p>
                 ...
                 <div class="dropdown">
                    <span><a href="#">Recently Viewed<i class="fa fa-caret-down"></i></a></span>
                        <div id="h"class="dropdown-content">
                        <div class="up">
                            <div>Resently Viewed</div>
                            <div>Manage all your recently viewed items ›</div>
                     ...
                     <div class="dropdown-content">
                        ...
                        <div id="down">
                            ...
                            <div class="down-second">
                                <img src="https://pisces.bbystatic.com/image2/BestBuy_US/en_US/images/abn/2015/global/qa2/sh_zs_bs_v2.png" alt="">
                            </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <div class="up">
                            <div>Saved Items</div>
                            <p>See all your saved items ›</p>
                            <div><i class="fa fa-times"></i>Close</div>
                        </div>
                        <div id="down">
                            <div class="down-first">
                                <h1>Looks like you don't have anything saved...</h1>
